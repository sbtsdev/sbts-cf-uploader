<div class="wrap sbts-cf-uploader">
	...
	<div class="file-upload">
		...
		<p class="fallbacks"><label>Drag &amp; drop not supported, but you can still upload via this input field:<input id="old_upload" name="file[]" type="file" multiple="multiple" /></label></p>
	</div>
